    ...
    while intentos < 3:
        ...
        if usuario == 10334151 and clave == 1803:
            ...
            if retiro > saldo_cuenta:
                ...
                cantidad_de_billetes = (retiro/5000)
                cantidad_de_billetes = int(cantidad_de_billetes)
                cantidad_de_billetes = str(cantidad_de_billetes)
                print("saldo cuenta="+saldo_cuenta)
                print("saldo cajero="+saldo_cajero)
                print("billetes 5000="+cantidad_de_billetes)
                break;
