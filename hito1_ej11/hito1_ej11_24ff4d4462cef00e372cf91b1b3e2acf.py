while True:
    import sys
    user= eval(input("Ingrese el usuario: "))
    ...
    ret= eval(input("Ingrese monto a retirar: "))
    if ret <= saldo_usuario:
        saldonuevo= saldo_usuario - ret
        saldocajero= saldo_base - ret
    ...
    orden = str(input("ingrese algo distinto a N para salir: "))
    if orden != "N":
