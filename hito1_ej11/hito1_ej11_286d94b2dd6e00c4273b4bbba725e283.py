        ...
        if monto_retiro <= saldo_inicial:
            if monto_retiro % 5000 == 0:
                ...
                if monto_retiro <= total_billetes:
                    ...
                    saldo_usuario -= (billetes_20000_retirados * 20000) + (billetes_10000_retirados * 10000) + (
                            billetes_5000_retirados * 5000)
                    saldo_inicial -= (billetes_20000_retirados * 20000) + (billetes_10000_retirados * 10000) + (
                            billetes_5000_retirados * 5000)
