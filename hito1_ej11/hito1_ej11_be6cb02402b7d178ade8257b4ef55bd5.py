...
while usuario == 0:
    if clave == 0:
        ...
        if monto_a_retirar in salir:
            ...
            a = int(monto_a_retirar) // 20000
            monto_a_retirar = int(monto_a_retirar) - (a*20000)
            b = int(monto_a_retirar) // 10000
            monto_a_retirar = int(monto_a_retirar) - (b*10000)
            c = int(monto_a_retirar) // 5000
            monto_a_retirar = int(monto_a_retirar) - (c*5000)
