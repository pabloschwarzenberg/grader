...
#al principio el saldo de 1.000.000 estará distribuido en 20 billetes de 20.000, 40 billetes de 10.000
#y 40 billetes de 5.000
billetes_20 = saldo_ic // 50000
billetes_40 = saldo_ic // 25000
billetes_5 = saldo_ic // 25000
#Cuando se haga un giro tu cajero además de imprimir los saldos
saldo_fcjr = saldo_ic-monto
saldo_fcta = saldo_iu-monto
print('Saldo cuenta=',saldo_fcta, 'Saldo cajero=',saldo_fcjr)

#debe imprimir la cantidad de billetes que le entrega a la persona,
#por ejemplo al retirar 45.000 podría imprimir: billetes 20000=1, billetes 10000=3, billetes 5000=1
if monto <= saldo_ic:
    billetes_20000 = monto // 20000
    print('billetes 20000=',billetes_20000)
    if int(monto % 20000) == 0:
        billetes_10000 = int(monto % 20000) // 10000
        print('billetes 10000=', billetes_10000)
    else:
        billetes_5000 = int(monto % 20000) // 5000
