...
usuario = int(input("Ingrese el numero de usuario: "))
...
while clave != passw:
  ...
  clave = int(input("Ingrese nuevamente su clave secreta: "))
...
if usuario == user :
  ...
  if clave == passw:
    ...
    monto = int(input("¿Cuanto es el monto que quiere retirar?: "))
