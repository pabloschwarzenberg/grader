...
while True: 
    if usuario == "10334151"and contraseña == "1803":
        ...
        if monto_a_retirar<saldo_usuario and monto_a_retirar<saldo_cajero:
            ...
            print("saldocuenta=", saldo_usuario_final)
            print("saldocajero=", saldo_cajero_final)
            ...
            print("billetes20000=", b20k)
            print("billetes10000=", b10k)
            print("billetes5000=", b5k)
     ...
     if usuario != "10334151" or contraseña != "1803":
         ...
         if usuario != "10334151"orcontraseña != "1803":
                print("clave invalida")
                sleep(1)
                print("INTENTO N°3")
                sleep(1)
                contraseña = str(int(input("Ingrese la contraseña denuevo:")))
                if usuario != "10334151"orcontraseña != "1803":print("tarjeta bloqueada")
                break     