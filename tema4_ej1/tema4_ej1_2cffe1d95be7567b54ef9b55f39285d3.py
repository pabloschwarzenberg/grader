...
def ocultar_letras(letra,lista):
    if len(palabras)>0:
        for idx in range(len(palabras)):
            if letra==palabras[idx]:
                return 1
        lista.append(letra)
    else:
        lista.append(letra)
...
def revisar_letra(letra,word,lista):
    pos=0
    indicador=0
...
if __name__=='__main__':
    ...
    while True:
        ...
        while True:
            ...
            res=ocultar_letras(letra,letras_almacenadas) #Verifica si la letra ingresada no se repite
            if res==0:
                break
        ...
        while True:
            vrf=revisar_letra(letra,word,construir_palabra) #Verifica si la letra ingresada se encuentra en la palabra oculta
