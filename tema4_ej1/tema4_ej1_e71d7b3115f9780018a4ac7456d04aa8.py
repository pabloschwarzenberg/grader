...
if __name__ == "__main__":
    listapalabras = ["panda","aluminio","huesos","colorado",
                 "provincia","recipiente","casco","trampa",
                 "tenedor","final","cenicero","micribio"]
    palabra1 = ocultar_letras(listapalabras,2)
    palabra1 = revisar_letra(palabra1,"l")
    print(palabra1)
    pass
