class JuegoDelGato:
    ...
    def jugarRaton(self):
        ...
        if len(movimientos) > 0:
            # Estrategia del ratón: elegir la esquina superior izquierda si está disponible,
            # de lo contrario, elegir la primera casilla vacía en el orden izquierda a derecha, arriba hacia abajo.
