...
class Analizador(analizador.util.AnalizadorBase):
    def __init__(self):
        ...
        self.output.append(["cantidad={}".format(cantidad),"promedio={}".format(promedio),"minimo={}".format(minimo)])
        self.setup.append([str(2),str(2),str(-1)])
        self.output.append(["cantidad={}".format(2),"promedio={:.1f}".format(2),"minimo={}".format(2)])
        self.setup.append([str(-1)])
        self.output.append(["cantidad={}".format(0),"promedio=nd","minimo=nd"])
        self.precondiciones=[
