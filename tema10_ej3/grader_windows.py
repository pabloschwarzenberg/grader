...
class Analizador(analizador.util.AnalizadorBase):
    ...
    def analizar(self):
        e=tema10_ej3.solucion.sopaletras("sopa.txt",["casa","cra","aro"])
        o=self.modulo.sopaletras("sopa.txt",["casa","cra","aro"])
...
if __name__=="__main__":
    ...
    analizador.modulo=tema10_ej3.solucion2
    analizador.analizar()
