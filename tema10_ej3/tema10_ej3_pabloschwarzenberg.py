...
#La función debía recibir una lista de palabras
#y debía retornar una lista de tuplas, que diga donde se puede encontrar cada palabra
#la forma en que lo solucioné, es crear otra función que llama a tu función original
#Se puede optimizar esta solución, ya que para cada palabra abre el archivo, puede ser un buen ejercicio
#cargar el archivo una sola vez y después usar la información que está en la memoria del computador
#para revisar cada palabra
