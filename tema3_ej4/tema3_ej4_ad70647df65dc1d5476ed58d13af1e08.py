class Fraccion:
    ...
    def __add__(self, other):
        if isinstance(other, Fraccion):
            ...
            raise TypeError("Se requiere un objeto de la clase Fraccion para la suma.")
    ...
    def __sub__(self, other):
        if isinstance(other, Fraccion):
            ...
            raise TypeError("Se requiere un objeto de la clase Fraccion para la resta.")
    ...
    def __mul__(self, other):
        if isinstance(other, Fraccion):
            ...
            raise TypeError("Se requiere un objeto de la clase Fraccion para la multiplicación.")
    ...
    def __truediv__(self, other):
        if isinstance(other, Fraccion):
            ...
            raise TypeError("Se requiere un objeto de la clase Fraccion para la división.")
