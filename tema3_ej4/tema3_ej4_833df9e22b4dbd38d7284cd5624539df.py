class Fraccion:
    ...
    def __sub__(self,other):
        if self.den==other.den:
            ...
            return Fraccion(numerador,self.den)
        if self.den!=other.den:
            a=self.den*other.den
            b=self.num*other.den
            c=other.num*self.den
            resta=b-c
            return Fraccion(resta,a)
    ...
    def __add__(self,other):
        ...
        if self.den!=other.den:
            ...
            c=other.num*self.den
            suma=b+c
            fraccion_final=suma/a
            return Fraccion(suma,a)

    def __truediv__(self,other):
        d=self.num*other.den
        e=self.den*other.num
        division=d/e
        return Fraccion(d,e)
