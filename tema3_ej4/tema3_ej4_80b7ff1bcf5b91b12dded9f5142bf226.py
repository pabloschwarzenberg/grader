#Completa la clase Fracción con los métodos necesarios para que se pueden
#sumar, restar y dividir fracciones.
...
class Fraccion:
    ...
    def __add__(self,other):
        s=Fraccion(0,0)
        s.num=(self.num*other.den)+(self.den*other.num)
        s.den=self.den*other.den
        return s
    
    def __sub__(self,other):
        re=Fraccion(0,0)
        re.num=(self.num*other.den)-(self.den*other.num)
        re.den=self.den*other.den
        return re
