# Suma de los divisores de un numero + Calculadora numeros primos
def suma_divisores(a):
  div_acumulador=0
  # Sumar los divisores del numero
  if a < 1:
    print("Error: el numero ingresado es invĂĄlido")
  else:
    for i in range(1, a):
        if (a%i == 0):
            div_acumulador+=i
...
if __name__ == "__main__":
  num=int(input("Ingrese un nĂşmero: "))
  # suma divisores, Âżes primo?
