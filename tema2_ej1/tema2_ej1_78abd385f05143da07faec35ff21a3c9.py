...
def calculo_area_rombo(diagonal_mayor, diagonal_menor):
...
if __name__ == "__main__":
    print("Programa de cálculo de áreas.")
    print("Elegir una figura geométrica para calcular su área:")
    print("1. Rectángulo")
    print("2. Triángulo")
    print("3. Rombo")
    print("4. Círculo")
    ...
    if opcion == 1:
        ...
        area = calculo_area_rectangulo(base, altura)
        print("El área del rectángulo es:", area)
    elif opcion == 2:
        base = float(input("Ingrese la base del triángulo: "))
        altura = float(input("Ingrese la altura del triángulo: "))
        area = calculo_area_triangulo(base, altura)
        ...
        area = calculo_area_rombo(diagonal_mayor, diagonal_menor)
