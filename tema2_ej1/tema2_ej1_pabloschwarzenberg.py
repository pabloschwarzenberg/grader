...
#el programa corrector revisa el código de tu programa
#para hacerlo lo importa
#por lo que todo el código que es global debe estar incluido dentro de un IF que es siempre igual
