print("Escriba el día y mes de su cumpleaños (en numeros enteros) para saber su zigno zodiacal")
dia=int(input("Día del cumpleaños: "))
mes=int(input("Mes del cumpleaños: "))
if (dia>=21 and mes==3) or (dia<=20 and mes==4):
    ...
    input("Por favor revise la fecha ingresada")