print("Al ingresar su fecha de nacimiento para saber tu signo zodiacal")
dia = int(input("Ingrese valor dia de nacimiento: "))
mes = int(input("Ingrese valor de mes de nacimiento: "))
