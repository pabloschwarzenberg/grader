...
# Solicitar al usuario el día y mes de cumpleaños
dia_cumple = int(input("Ingrese el día de cumpleaños (número entero): "))
mes_cumple = int(input("Ingrese el mes de cumpleaños (número entero): "))
