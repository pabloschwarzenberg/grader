...
if (mes == 3 and dia >= 21 and dia <= 31) or (mes == 4 and dia >=1 and dia <= 20):
    print("aries")
elif (mes == 4 and dia >= 20 and dia <= 31) or (mes == 5 and dia >=1 and dia <= 21):
    print("tauro")
    ...
    print("virgo")
elif (mes == 9 and dia >= 23 and dia <= 31) or (mes == 10 and dia >=1 and dia <= 23):
    print("libra")
elif (mes == 10 and dia >= 23 and dia <= 31) or (mes == 11 and dia >=1 and dia <= 22):
    print("escorpio")
elif (mes == 11 and dia >= 22 and dia <= 31) or (mes == 12 and dia >=1 and dia <= 22):
    print("sagitario")
    ...
    print("acuario")
elif (mes == 2 and dia >= 19 and dia <= 31) or (mes == 3 and dia >=1 and dia <= 21):
    print("piscis")
