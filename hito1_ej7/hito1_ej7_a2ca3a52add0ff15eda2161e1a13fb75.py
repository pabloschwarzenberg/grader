#Zodiaco
dia = int(input("el usario debe ingresar el dia de su nacimiento "))
while dia < 0 or dia > 31:
    dia = int(input("el usuario debe ingrsar el mes en el cual el nacio" ))

mes = int(input(" el usuario debe ingresar su mes en el cual nacio "))
while mes <= 0 or mes > 12:
   mes = int(input("ingrese mes en el cual nacio "))
...
print("el signo segun el usuario es",signo)     