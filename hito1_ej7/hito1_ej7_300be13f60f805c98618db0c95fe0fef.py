...
# Pedir al usuario el día y el mes de cumpleaños
dia = int(input("Ingresa el día de tu cumpleaños (número): "))
mes = int(input("Ingresa el mes de tu cumpleaños (número): "))
