dia = int(input("dame el dia de tu nacimiento: "))
mes = int(input("dame el mes de tu nacimiento: "))
...
if mes == 3 and 21 <= dia >= 31 or mes == 4 and 1 <= dia > 20:
    ...
    print("escorpio")
elif mes == 11 and 23 <= dia >= 31 or mes == 12 and 1 <= dia > 22:
    print("sagitario")
elif mes == 12 and 22 <= dia >= 31 or mes == 1 and 1 <= dia > 20:
    print("capricornio")
elif mes == 1 and 20 <= dia >= 31 or mes == 2 and 1 <= dia > 19:
    print("acuario")
elif mes == 2 and 19 <= dia >= 31 or mes == 2 and 3 <= dia > 21:
    print("piscis")