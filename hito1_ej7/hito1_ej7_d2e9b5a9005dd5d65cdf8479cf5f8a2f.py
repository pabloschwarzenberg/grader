dia = int(input("Seleccione el dia de su cumpleaños: "))
mes = int(input("Seleccione el mes de su cumpleaños: "))
...
if (dia >=23 and mes == 11) or (dia <=22 and mes == 12):
   print("Sagitario")
if (dia >=22 and mes == 12) or (dia <=22 and mes == 1):
   print("Capricornio")
if (dia >=20 and mes == 1) or (dia <=22 and mes == 2):
   print("Acuario")
