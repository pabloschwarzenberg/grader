#zodiaco
#a cada mes de se le asigna un valor por ejemplo: enero(1),febrero(2)...etc
dia = int (input ("Ingresa tu dia de nacimiiento: "))
mes = int (input ("Ingresa el valor del mes en que naciste : "))
