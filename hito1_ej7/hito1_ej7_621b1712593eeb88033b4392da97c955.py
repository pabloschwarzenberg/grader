#Zodiaco
dia=int(input("ingrese su dia de cumleaños:"))
mes=int(input("ingrese su mes de cumpleaños:"))

if dia>=20 and mes==3 or dia<=20 and mes==4:
 print("Aries")
  ...
  print("Sagitario")
elif dia>=20 and mes==12 or dia<=20 and mes==1:
  print("Capricornio")
elif dia>=10 and mes==1 or dia<=19 and mes==2:
  print("Acuario")
