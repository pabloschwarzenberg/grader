...
if a>=22 and b==11 or a<=22 and b==12:
    print("Sagitario")
elif a>=23 and b==1 or a<=20 and b==1:
    print("Capricornio")
elif a>=21 and b==1 or a<=19 and b==2:
    print("Acuario")
elif a>=20 and b==2 or a<=21 and b==3:
    print("Piscis")
elif a>=22 and b==3 or a<=20 and b==4:
    print("Aries")
    ...
    print("Escorpio")
elif a>=23 and b==11 or a<=21 and b==1:
    print("Ofiuco")
