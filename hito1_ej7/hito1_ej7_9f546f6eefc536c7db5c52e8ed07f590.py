def determinar_el_signo_del_zodiaco(dia, mes):
...
dia_cumpleanos = int(input("Ingrese el día de su cumpleaños (1-31): "))
mes_cumpleanos = int(input("Ingrese el mes de su cumpleaños (1-12): "))


signo_zodiaco = determinar_el_signo_del_zodiaco(dia_cumpleanos, mes_cumpleanos)
