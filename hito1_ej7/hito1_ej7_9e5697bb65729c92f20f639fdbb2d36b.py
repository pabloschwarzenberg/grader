...
# Obtener el día y mes de cumpleaños del usuario
dia_cumple = int(input("Ingresa el día de tu cumpleaños (número entero): "))
mes_cumple = int(input("Ingresa el mes de tu cumpleaños (número entero): "))

# Determinar el signo del zodíaco
signo_zodiaco = determinar_signo_zodiaco(dia_cumple, mes_cumple)
