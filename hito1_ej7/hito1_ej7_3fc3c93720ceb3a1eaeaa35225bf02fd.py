...
mes = int(input("Ingrese su mes de naciento "))

if (mes == 3 and 21 <= dia <=31):
  print("Aries")
elif (mes == 4 and 1<= dia <= 20):
  print("Aries")
elif (mes == 4 and 20 <= dia <=30):
  print("Tauro")
  ...
  print("escorpio")elif (mes == 11 and 23 <= dia <=30):
  print("sagitario")
  ...
  print("capricornio")
elif (mes == 1 and 20 <= dia <=31):
  print("acuario")
elif (mes == 2 and 1<= dia <= 19):
  print("acuario")
elif (mes == 2 and 19 <= dia <=28):
  print("piscis")
elif (mes == 2 and 1<= dia <= 21):
  print("piscis")
