#Zodiaco
print("importante ingresar el numero del dia")
dia = int(input("dia en el cual nacio: "))
print("importante ingresar el numero del mes")
mes = int(input("mes en el cual nacio: "))
