#Zodiaco
dia = int(input("indica tu dia de nacimento: "))
mes = int(input("indica tu mes de nacimento: "))
...
if mes == 9 and dia >= 23 and dia <= 30:
    print("libra")
...
if mes == 2 and dia >= 1 and dia <=18:
    print("acuario")

if mes == 2 and dia >= 19 and dia <= 28:
    print("picsis")
