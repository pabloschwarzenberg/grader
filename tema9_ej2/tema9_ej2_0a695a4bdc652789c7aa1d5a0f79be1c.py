class Matriz:
    ...
    def __mul__(self, other):
        if len(self.celdas[0]) != len(other.celdas):
            raise ValueError("Las matrices no se pueden multiplicar debido a tamaños incompatibles.")

        # Crear una nueva matriz de resultados con las dimensiones adecuadas
