...
while True:
 ...
 if opcion == "checkout":
  ...
  if not(carro[3][1] == 0) and not(carro[4][1] == 0):
   descuentoP2 = 0.15
  print(round((carro[0][3] * (1-descuentoP1))*carro[0][1],1))
  print(round((carro[1][3] * (1-descuentoP1))*carro[1][1],1))
  print(round((carro[2][3] * (1-descuentoP1))*carro[2][1],1))
  print(round((carro[3][3] * (1-descuentoP2))*carro[3][1],1))
  print(round((carro[4][3] * (1-descuentoP2))*carro[4][1],1))