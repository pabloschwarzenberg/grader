...
if __name__ == "__main__":
    archivo = "sopa.txt"
    palabras = []
    anadir_palabra = input("Ingrese una palabra: ")
    palabras.append(anadir_palabra)
    resultado = sopaletras(archivo, palabras)
    if resultado:
        for res in resultado:
            palabra, coordenadas, direccion = res
            print(f"La palabra '{palabra}' se encuentra en las coordenadas {coordenadas} en dirección {direccion}.")
    else:
