...
Aquí tienes la función estadisticas_frase que cumple con los requisitos solicitados:
...
def estadisticas_frase(s):
    ...
    num_puntuacion = sum(caracter in string.punctuation for caracter in s if caracter != ' ')
