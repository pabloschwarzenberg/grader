...
def estadisticas_frase(s):
    ...
    total_largo_palabras = sum(len(palabra.strip(string.punctuation)) for palabra in palabras)
    largo_promedio_palabras = total_largo_palabras / num_palabras
    ...
    num_caracteres_puntuacion = sum(caracter in caracteres_puntuacion for caracter in s)
