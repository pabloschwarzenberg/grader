...
def estadisticas_frase(frase):
    ...
    num_puntuacion = sum(caracter in string.punctuation for caracter in frase if caracter not in string.whitespace)
...
circundado de cerros imaginarios..."""
    ...
    print(resultado)  # Debería imprimir: (75, 521, 5.88, 59, 3)
