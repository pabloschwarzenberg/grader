...
class Entrenador:
    def _init_(self,nombre,lista_pokemon):
        self.nombre=nombre
        self.lista_pokemon=lista_pokemon

  #  def primer_pokemon(self):
        i=0
        while i<len(self.pokemon):
            pokemon=self.lista_pokemon[i]


class Batalla:
    def _init_(self,contrincante1,contrincate2):
