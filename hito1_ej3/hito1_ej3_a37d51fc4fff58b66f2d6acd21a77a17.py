...
def evaluar_credito(ingreso, año_nacimiento, num_hijos, años_pertenencia, estado_civil, lugar_residencia):
...
resultado = evaluar_credito(ingreso, año_nacimiento, num_hijos, años_pertenencia, estado_civil, lugar_residencia)
