def evaluar_aprobacion(ingreso, año_nacimiento, num_hijos, años_banco, estado_civil, ubicacion):
...
resultado = evaluar_aprobacion(ingreso, año_nacimiento, num_hijos, años_banco, estado_civil, ubicacion)
