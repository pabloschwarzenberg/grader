...
Aio_nacimiento = int(input("Ingrese su año de nacimiento:"))
num_h = int(input("Ingrese la cantidad de hijos que tiene:"))
AIOS_banco = int(input("Ingresa los años que llevas en el banco:"))
...
while True:
    ...
    if estado_civil=="C":
        if num_h>3:
            if (Aio_nacimiento-2020)>=45 and (Aio_nacimiento-2020)<=55:
                print("\033[4;42m"+"APROBADO")
                sleep(1)
                break
    if ingreso>2500000:
