...
if a_pertenencia > 10 and n_hijos >= 2:
    print("APROBADO")
    exit(0)
elif e_civil == "C" and n_hijos > 3 and (2020 - a_nacimiento <= 55 and 2020 - a_nacimiento >= 45):
    print("APROBADO")
elif ingreso > 2500000 and e_civil == "S" and locacion == "U":
    print("APROBADO")
elif ingreso > 3500000 and a_pertenencia > 5:
    print("APROBADO")
elif locacion == "R" and e_civil == "C" and n_hijos < 2:
    print("APROBADO")
else:
    print("RECHAZADO") 