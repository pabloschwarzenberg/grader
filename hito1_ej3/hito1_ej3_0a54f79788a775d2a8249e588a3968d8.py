...
def aprobacion (ingreso, año_nacimiento, num_hijos, años_pertenencia, estado_civil, lugar_residencia):
...
if aprobacion(ingreso, año_nacimiento, num_hijos, años_pertenencia, estado_civil, lugar_residencia):
    print("APROBADO")
else:
    print("RECHAZADO")