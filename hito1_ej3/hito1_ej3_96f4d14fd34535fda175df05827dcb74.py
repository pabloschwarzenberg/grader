...
def verificar_aprobacion(ingreso, anio_nacimiento, num_hijos, anios_pertenencia, estado_civil, ubicacion):
...
aprobado = verificar_aprobacion(ingreso, anio_nacimiento, num_hijos, anios_pertenencia, estado_civil, ubicacion)
