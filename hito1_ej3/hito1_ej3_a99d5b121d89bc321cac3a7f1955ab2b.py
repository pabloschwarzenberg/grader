...
elif (estadoCivil == "C") and (númeroHijos > 4) and (Edad >= 44 and Edad <= 56):
    print("APROBADO")

elif (Ingreso > 2000000) and (estadoCivil == "S") and (Vivienda == "U"):
    print("APROBADO")

elif (Ingreso > 3000000) and (AñosPertenenciaBanco > 6):
    print("APROBADO")
