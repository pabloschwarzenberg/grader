...
def solicitar_informacion():
    ...
    anos_pertenencia = int(input("Ingrese el número de años que ha pertenecido al banco: "))
...
def main():
    ingreso, ano_nacimiento, num_hijos, anos_pertenencia, estado_civil, tipo_vivienda = solicitar_informacion()
