...
domicilio=str(input("Ingrese si su domicilio es rural o urbano. R=Rural y U=Urbano: "))
if(years>10) and (hijos>=2):
  print("APROBADO")
elif(civil==C) and (hijos>3) and ((nacimiento>=1967) or (nacimiento<=1977)):
    print("APROBADO")
elif(ingresos>2500000) and ((civil==S) and (domicilio==U)):
    print("APROBADO")
elif(ingresos>3500000) and (years>5):
    print("APROBADO")
elif(domicilio==R) and (civil==C) or (hijos<2):
  print("APROBADO")
else:
    print("RECHAZADO")
