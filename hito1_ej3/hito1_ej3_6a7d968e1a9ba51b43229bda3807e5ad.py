...
elif tcivil=="C" and nhijos > 3 and nacido >= 1966 or nacido <= 1956:
    print("APROBADO")
 
#Si el gana+ de 2500000, es soltero y viveen ciudad
elif ing > 2500000 and tcivil=="S" and residencia=="u" or "U":
    print("APROBADO") 
...
elif residencia=="R" and tcivil=="C" and nhijos < 2:
    print("APROBADO")
