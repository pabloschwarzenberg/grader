...
añodeper=int(input("ingrese los años de pertenencia al banco: "))
...
if añodeper>10 and numero_hijos>=2:
    ...
    if (estado== "c" or estado == "C") and numero_hijos > 3 and (edad>45and edad<55):
        print("APROBADO")
    else:
        if ingreso > 2500000 and (estado=="s" or estado=="S") and (vivienda == "U" or estado == "U"):
            print("APROBADO")
        else:
            if ingreso> 3500000 and añodeper >5:
                print("APROBADO")
            else:
