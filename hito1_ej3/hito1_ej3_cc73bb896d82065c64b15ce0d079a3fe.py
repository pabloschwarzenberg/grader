...
Ingreso = eval(input("Ingrese su monto en pesos:"))
AñoNacimiento = eval(input("Ingrese su año de nacimiento:"))
NumeroHijos = eval(input("Ingrese cantidad de hijos:"))
AñosEnBanco = eval(input("Ingrese años de pertenencia al banco]:"))
