...
año_banco = int(input("Ingresa años en el banco:"))
estado_civil = input("Ingresa estado civil, (S) o (C): ")
campo_ciudad = input("Ingresa sector de recidencia, (U) o (R): ")
a1 = Aprobacion_1(año_banco,num_hijos)
a2 = Aprobacion_2(estado_civil,num_hijos,año_nacimiento)
a3 = Aprobacion_3(ingreso,estado_civil,campo_ciudad)
a4 = Aprobacion_4(ingreso,año_banco)
