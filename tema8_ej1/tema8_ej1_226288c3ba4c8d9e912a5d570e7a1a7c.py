...
class Carro:
    ...
    def calcular_descuentos(self):
        descuentos = 0
        for item in self.lista_de_productos:
            descuentos += item.producto.precio * item.cantidad * (self.descuento / 100)
        return descuentos

    def calcular_despacho(self, tipoDespacho):
        valor_productos = self.total - self.calcular_descuentos()
        if tipoDespacho == 0:
    ...
    def checkout(self, tipoDespacho, direccion):
        ...
        total = self.total - descuentos + despacho
