...
class Carro:
    ...
    def checkout(self,tipoDespacho,direccion):
        if tipoDespacho == 1:
          self.lista_de_productos = float(self.lista_de_productos-(self.lista_de_productos*30)/100)
        else:
          self.lista_de_productos = float(self.lista_de_productos-(self.lista_de_productos*20)/100)
        if self.direccion == "Alameda 340 Santiago Chile":   
          self.total = self.lista_de_productos-(self.lista_de_productos*20)/100
        else:
          self.total = self.lista_de_productos
        return self.total
