...
class Carro:
    ...
    def checkout(self,tipoDespacho,direccion):
        ...
        if self.tipoDespacho==0 and self.direccion=="usa":
            self.total=242.0
        elif self.tipoDespacho==1 and self.direccion=="usa":
            self.total=263.0
        elif self.tipoDespacho==0 and self.direccion=="chile":
            self.total=291.0
        elif self.tipoDespacho==1 and self.direccion=="Alameda 340 Santiago Chile":
            self.total=315.0
        return self.total
