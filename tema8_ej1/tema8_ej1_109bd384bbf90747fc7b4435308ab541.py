...
class Carro:
    ...
    def checkout(self, tipoDespacho, direccion):
        ...
        if tipoDespacho == 0:  # Despacho Aéreo Normal
            descuento_total = valor_productos * 0.2
        elif tipoDespacho == 1:  # Despacho Aéreo Express
            descuento_total = valor_productos * 0.3

        valor_despacho = valor_productos - descuento_total

        if "chile" in direccion.lower():
            valor_total = valor_despacho + (valor_despacho * impuesto)
        else:
