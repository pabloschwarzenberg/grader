...
class Carro:
    ...
    def calcular_despacho(self, tipoDespacho):
        total_productos = self.calcular_descuentos()
    ...
    def checkout(self, tipoDespacho, direccion):
        self.descuento = self.calcular_descuentos()
        self.total = self.descuento - self.calcular_despacho(tipoDespacho) + self.calcular_impuesto()
