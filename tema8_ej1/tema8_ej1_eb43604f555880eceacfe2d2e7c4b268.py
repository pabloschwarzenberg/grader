    ...
    def checkout(self,tipoDespacho,direccion):
       if tipoDespacho==0:
         for i in self.lista_de_productos:
           self.total+=i.precio()*0.2
       else:
         for i in self.lista_de_productos:
           self.total+=i.precio()*0.3
       if self.direccion.find("Chile")>-1:
...
class Tienda:
    def  __init__(self):
        self.catalogo=[]
        producto=Producto("Juego Pokemon Y",10,31.51)
        ...
        self.catalogo.append(producto)
        producto=Producto("Fifa 14",10,41.95)
        self.catalogo.append(producto)
