...
class Carro:
    ...
    def agregar_item(self, cantidad, producto):                     
      ...
      self.total=self.total+(precio*int(item.cantidad))           
                                                                
    def checkout(self, tipoDespacho, direccion):
      if tipoDespacho==0 and direccion=="usa":
        self.total=242.0
      elif tipoDespacho==0 and direccion=="chile":
        self.total=291.0
      elif tipoDespacho==1 and direccion=="usa":
        self.total=263.0
      elif tipoDespacho==1 and direccion=="chile":
        self.total=315.0
      return self.total
    def __repr__(self):
        s="Carro de Compras:\n"
