...
class Carro:
    ...
    def calcular_despacho(self, tipoDespacho):
        ...
        if tipoDespacho == 0:
            # Despacho Aéreo Normal
            self.total = subtotal - self.descuento + subtotal * 0.2
        elif tipoDespacho == 1:
            # Despacho Aéreo Express
            self.total = subtotal - self.descuento + subtotal * 0.3
    ...
    def checkout(self, tipoDespacho, direccion):
        ...
        if "chile" in direccion.lower():
            self.total += self.total * 0.2  # Agregar 20% de impuestos si el despacho es hacia Chile
