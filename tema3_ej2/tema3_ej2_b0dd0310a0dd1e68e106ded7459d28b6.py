...
#mantuve los nombres de los parámetros pero esta es una función no un método
#de una clase, por lo que self no es más que el primer parámetro y other el segundo
