class FechaHora:
    ...
    def fijarFecha(self, fecha):
        ...
        if len(fecha_parts) != 3:
            fecha_parts = fecha.split("-")
        if len(fecha_parts) != 3:
            raise ValueError("Formato de fecha invÃ¡lido. Debe ser dd/mm/aaaa o dd-mm-aaaa.")
    ...
    def fijarHora(self, hora):
        ...
        if len(hora_parts) != 3:
            raise ValueError("Formato de hora invÃ¡lido. Debe ser HH:MM:SS.")
    ...
    def fijarFechaHora(self, fecha_hora):
        ...
        if len(fecha_hora_parts) != 2:
            raise ValueError("Formato de fecha y hora invÃ¡lido. Debe ser dd/mm/aaaa HH:MM:SS.")
    ...
    def cambiar(self, parametro):
        ...
        if len(parametro_parts) != 2:
            raise ValueError("Formato de cambio invÃ¡lido. Debe ser 'tipo=valor'.")
        ...
        if tipo == "dd":
            ...
            raise ValueError("Tipo de parÃ¡metro invÃ¡lido.")
