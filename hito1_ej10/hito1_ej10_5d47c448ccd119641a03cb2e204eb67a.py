...
usuario = str(int(input("Adjunte el usuario: ")))
contrasena = str(int(input("Adjunte la contraseña: ")))
while True:
    if usuario == "10334151" and contrasena == "1803":
        print("Usuario y contraseña correctos")
        sleep(1)
        monto_a_retirar = int(input("Adjunte el monto que desea retirar: "))
    ...
    if usuario != "10334151" or contrasena != "1803":
        ...
        print("INTENTO N°2")
        sleep(1)
        contrasena = str(int(input("Adjunte la contraseña nuevamente: ")))
        if usuario != "10334151" or contrasena != "1803":
            print("clave invalida")
            sleep(1)
            print("INTENTO N°3")
