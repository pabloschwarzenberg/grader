    ...
    while True:
        ...
        if confirmao==True:
            ...
            if retiro <0 or retiro>1000000:
                ...
                print('billetes 20000: %s' %(str(billetes20000)))
                print('billetes 10000: %s' %(str(billetes10000)))
                print('billetes 5000: %s' %(str(billetes5000)))
                print("suma de billetes: %s" %(str(20000*billetes20000 + 5000*billetes5000)))
